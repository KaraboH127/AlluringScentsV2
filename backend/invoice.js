...
const LOGO_URL =
  "https://alluring-scents-v2.vercel.app/Alluring_scents_logo.webp";
...
const FRAGRANCE_COLLECTIONS = {
  lush: "standard",
  "whiskey-sour": "standard",
  "velvet-nectar": "standard",
  "midnight-oud": "standard",
  "purple-rain": "standard",
  taboo: "standard",
  "ocean-eyes": "standard",
  fresh: "standard",
  "9-lives": "private",
  "golden-amber": "private",
  "island-water": "private",
  signature: "private",
};
    ...
    try {
      ...
      try {
        ...
        doc
          ...
          .fontSize(8)
          .fillColor(GREY)
          .text("Extrait de Parfum  |  South Africa  |  Est. 2024", M, 56);
      }
      ...
      const badgeX = W - M - 80;
      doc
        .rect(badgeX, metaY, 80, 22)
        .fill(order.status === "shipped" ? "#16a34a" : "#c9a84c");
      doc
        .font("Helvetica-Bold")
        .fontSize(8)
        .fillColor(WHITE)
      ...
      doc
        ...
        .text(fmt(order.amount_in_cents), totX, rowY + 4, {
          align: "right",
          width: 150,
        });
      ...
      doc
        ...
        .fillColor(GREY)
        .text(
          "Your trust is the greatest compliment we could have gotten. You smell scent-sational.",
          0,
          H - 36,
          {
            align: "center",
        ...
        .text(
          "alluringscents6@gmail.com  |  alluring-scents.co.za",
          0,
          H - 22,
          {
            align: "center",
