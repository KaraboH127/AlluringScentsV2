  ...
  return (
    <>
      ...
      <section className="relative min-h-[60vh]">
        <img src={siteConfig.images.founders} alt="Founders of Alluring Scents" className="absolute inset-0 h-full w-full object-cover opacity-35" />
        <div className="absolute inset-0 bg-black/65" />
        <div className="relative mx-auto max-w-6xl px-4 py-20 sm:px-6">
          <p className="text-xs uppercase tracking-[0.24em] text-[#C9A227]">Our Story</p>
          <h1 className="mt-4 max-w-3xl text-5xl leading-tight text-white md:text-6xl">A Conversation That Became a Fragrance House.</h1>
        </div>
      </section>
      ...
      <Section>
        <div className="grid gap-12 lg:grid-cols-2">
          <article className="space-y-4">
            <h2 className="text-3xl text-white">Our Beginning</h2>
      ...
      <Section className="border-y border-[#1D1D1D] bg-[#0D0D0D]">
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <article className="space-y-4">
            <h2 className="text-3xl text-white">The Founders</h2>
            <p className="text-[#CFCFCF]">
      ...
      <Section>
        <div className="space-y-12">
          <article className="space-y-4">
            <h2 className="text-3xl text-white">Craftsmanship</h2>
            <p className="max-w-3xl text-[#CFCFCF]">
          ...
          <article className="space-y-4">
            <h2 className="text-3xl text-white">Our Philosophy</h2>
            <p className="max-w-3xl text-[#CFCFCF]">
